...
real_gas_models::DerivateFunctorOutflow::DerivateFunctorOutflow(const real_gas_models::balloon &bl,
                         real_gas_models::gasparameters &outbl, real_gas_models::modelGeneral *pmg)
  :bl_(bl),outbl_(outbl) {
  pmg->dynamicflowAccept(*this);
}
...
void real_gas_models::DerivateFunctorOutflow::getFunctor(real_gas_models::idealGas &mg) {
  derivfunc_ = OUTdXdtIdGas(mg,bl_,outbl_);
}

void real_gas_models::DerivateFunctorOutflow::getFunctor(real_gas_models::Redlich_Kwong2 &mg) {
  derivfunc_ = OUTdXdtRK2(mg,bl_,outbl_);
}

void real_gas_models::DerivateFunctorOutflow::getFunctor(real_gas_models::Peng_Robinson &mg) {
