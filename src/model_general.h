#ifndef MODEL_GENERAL
#define MODEL_GENERAL
...
namespace real_gas_models {
  ...
  typedef std::function <void (const difresult_t &x, difresult_t &dxdt, double t)>   difEquat_t;
  ...
  public:
    ...
    parameters getParametersCopy()        const;      //return struct {volume, pressure, temperature};
  ...
  public:
    gasparametersConverter(modelGeneral *md);
    ~gasparametersConverter();
  };
